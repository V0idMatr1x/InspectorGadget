...
This project is the spiritual successor to [SimpleFetch](github.com/V0idMatr1x/simplefetch) which is less featureful and written in Python which has obvious limitations for this use case.
